    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <form
            ...
            <div>
                ...
                <select name="organization_id"
                    ...
                    @foreach ($organizations as $org)
                        <option value="{{ $org->id }}"
                            {{ isset($department) && $department->organization_id == $org->id ? 'selected' : '' }}>
                            {{ $org->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Auto-generated from name, can be customized.</p>
                @error('slug')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" id="generateCode"
                        class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">Generate</button>
                </div>
                @error('code')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
