<x-viewer-layout>
    <div class="max-w-3xl mx-auto py-10">
        <h2 class="text-2xl font-bold mb-6">Casual Leave Request</h2>
        ...
        <form action="{{ route('vacations.casual.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="medical_certificate" class="block font-medium mb-1">Medical Certificate
                        (PDF/JPG/PNG)</label>
                    <input type="file" name="medical_certificate" id="medical_certificate" class="w-full">
                </div>
            </div>
